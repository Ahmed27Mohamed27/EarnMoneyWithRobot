...
public class AdminDepostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_depost);
        ...
        reference= FirebaseDatabase.getInstance().getReference().child("Users").child(uid);
            ...
            public void onClick(View view) {
                reference.child("withdraw").child("depost").child("none").removeValue();
                Toast.makeText(AdminDepostActivity.this, "تم", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                map.put("none", "ملغي");
                reference.child("withdraw").child("depost").updateChildren(map);
                Toast.makeText(AdminDepostActivity.this, "تم", Toast.LENGTH_SHORT).show();
            }
        });
